...
#define push_server		@"http://sz.zcom.com:8090/pubnotify/itoken/mkup"
...
{
    NSString *urlString = [NSString stringWithFormat:@"%@/%@", push_url, deviceToken];
...
{   
    ...
    NSLog(@"%@", conn.currentRequest.URL.absoluteString);
}
